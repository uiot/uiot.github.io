        ...
        <v-row>
          ...
          <v-col cols="6">
            <v-btn
              rounded
              outlined
              :class="`blue ${chardware}`"
              @click="filterMembers('hardware')"
            >
              Hardware
            </v-btn>
            <v-btn
              rounded
              outlined
              :class="`green ${csoftware}`"
              @click="filterMembers('software')"
            >
              Software
            </v-btn>
            <v-btn
            ...
            <v-btn
              rounded
              outlined
              :class="`purple ${cquality}`"
              @click="filterMembers('quality')"
            >
              Quality
            </v-btn>
          </v-col>
...
export default {
  ...
  computed: {
    coordination() {
      return new filterMembers().byAreaCurrent("coordination");
    },
    software() {
      return new filterMembers().byAreaCurrent("software");
    },
    hardware() {
      return new filterMembers().byAreaCurrent("hardware");
    },
    security() {
      return new filterMembers().byAreaCurrent("security");
    },
    quality() {
      return new filterMembers().byAreaCurrent("quality");
    },

    lcoordination() {
      return new filterMembers().byAreaLeft("coordination");
    },
    lsoftware() {
      return new filterMembers().byAreaLeft("software");
    },
    lhardware() {
      return new filterMembers().byAreaLeft("hardware");
    },
    lsecurity() {
      return new filterMembers().byAreaLeft("security");
    },
    lquality() {
