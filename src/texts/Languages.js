const Languages =  {
    ...
    Portugues : {
        ...
        wwdo: {
            ...
            text: "O UIoT é um laboratório de pesquisa científica em aplicações que envovlve Tnternet das Coisas (IoT). Aqui desenvolvemos projetos que envolvem a solução completa, envolvendo o sistema destes dispositivos (software), a parte física (hardware) e também a segurança da informação",
            hardware: {
                title: "Hardware",
